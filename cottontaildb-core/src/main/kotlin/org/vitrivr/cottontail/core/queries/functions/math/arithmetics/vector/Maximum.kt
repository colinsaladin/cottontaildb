 ...
 * @version 1.0.0
 */
sealed class Maximum<T : VectorValue<*>>(val type: Types.Vector<T,*>): VectorizableFunction<T> {
     ...
     */
    class FloatVector(type: Types.FloatVector): Maximum<FloatVectorValue>(type), VectorizedFunction<FloatVectorValue> {
