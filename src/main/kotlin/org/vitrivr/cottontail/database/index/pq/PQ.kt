...
import org.vitrivr.cottontail.database.catalogue.entries.IndexStructCatalogueEntry
 ...
 * @version 2.0.0
 */
class PQ(name: String, val type: Type<*>, val codebooks: List<PQCodebook<VectorValue<*>>>): IndexStructCatalogueEntry(name) {
